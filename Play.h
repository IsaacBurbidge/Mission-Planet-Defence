...
namespace Play
{
	...
	void PointGameObject( GameObject& obj, float speed, int targetX, int targetY );
...
namespace Play
{
	...
	void PointGameObject( GameObject& obj, float speed, int targetX, int targetY )
	{
		...
		obj.acceleration.x = speed * sin( obj.rotation );
		obj.acceleration.y = speed * -cos( obj.rotation );
		if (obj.velocity.y > 0.5) {
